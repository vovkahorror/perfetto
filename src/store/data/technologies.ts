...
export const beanSwitch = new Technology(
    ...
    ['wA-Q9LzAZM8'],
    'Bean Switch *',
    'З новою системою Bean Switch ви можете легко досліджувати світ кави та знаходити свої улюблені сорти та смаки. Просто наповніть різні зерна в 2 окремі контейнери по 250 г. Це функціональне рішення, наприклад, якщо ви любите вранці пити міцнішу каву - робусту або арабіку - а ввечері насолоджуватися її версією без кофеїну. Або, можливо, ваша друга половинка віддає перевагу іншим видам зерен?',
);