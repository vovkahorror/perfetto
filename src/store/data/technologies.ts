...
export const brewingUnit = new Technology(
    ...
    'Діапазон тиску пресування від 20 до 40 кг. Фаза перед заварюванням гарантує, що мелена кава буде рівномірно зволожена водою, щоб забезпечити оптимальне заварювання. На наступній стадії вода протікає через каву з певною швидкістю та з правильним тиском, щоб гарантувати ідеальний аромат, уникаючи недостатньої чи надмірної екстракції.',
);
