...
export const ESPRESSO_SOUL = 'Espresso SOUL';
...
export const COLD_COFFEE_MIX_CARAFE = 'Cold Coffee (MixCarafe)';
...
export const COLD_MILK_FOAM_MIX_CARAFE = 'Cold Milk Foam (MixCarafe)';
...
export const CHOCOLATE_MIX_CARAFE = 'Chocolate (MixCarafe)';
